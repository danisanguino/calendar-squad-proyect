export const domElements = {
  ...
  eventModalEndDateCheck: document.getElementById("end-date-checkbox") as HTMLInputElement,
  eventModalEndDate: document.getElementById("end-date-container") as HTMLDivElement,
  eventModalEndDateTime: document.getElementById("end-date-calendar") as HTMLInputElement,
  eventModalInitialDate: document.getElementById("initial-date") as HTMLInputElement,
